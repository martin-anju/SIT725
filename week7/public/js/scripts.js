document.addEventListener("DOMContentLoaded", function () {
  ...
  // Listen to the 'number' event from the server and display it
  socket.on("number", (msg) => {
    console.log("Random number:", msg);
    document.getElementById("number").innerText = msg; // Update the DOM with the random number
  });
  ...
  // Handle form submissions for new socket location
